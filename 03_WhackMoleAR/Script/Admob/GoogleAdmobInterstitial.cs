...
public class GoogleAdmobInterstitial : MonoBehaviour
{
    ...
    private void RequestInterstitial()
    {
        // インタースティシャル広告ID
#if UNITY_ANDROID
        string adUnitId = GameUtil.Const.ADMOB_ANDROID_INTERSTITIAL_ID;
#elif UNITY_IPHONE
        string adUnitId = GameUtil.Const.ADMOB_IOS_INTERSTITIAL_ID;
#else
    ...
    private void LoadNextScene()
    {
        ...
        SceneManager.LoadSceneAsync(GameUtil.Const.SCENE_NAME_GAME).AsObservable()
            .Subscribe(_ =>
            {
                ...
                gameSceneManager.playMode = param;
            });
    }
